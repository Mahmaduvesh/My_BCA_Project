	...
	<!-- End header -->
	 ...
	 <div class="regmain">
		...
		<form action="" method="post" >
			...
			<input type="text"  class="sem" name="sem" placeholder="Enter  New semester " required="">
			
			<input type="date" class="date" name="date"   required="">
				
			
			<input type="submit" name="submit" Value="submit" class="sub" >
			<input type="submit" name="submit" Value="View" class="sub" onclick="document.location='add_sem.php'">
		</form>
	</div>
...
<?php
	...
	if (isset ($_POST["submit"]))
	{
		...
		$sql= "INSERT INTO sem(sem,date) 
		VALUES
		('$sem', '$date')";
		
		if(mysqli_query($conn,$sql))
		{
			echo ' <script>alert("Semster added Registration Successfully!!")</script>';
		}
		else
		{
