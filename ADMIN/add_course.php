    ...
    <div class="row">
        ...
        ?><div class="container msg">
          ...
          ?><div class="container msg">
			...
			<button onclick="document.location='course_form.php'" class="sub">+ Add course</button>
			
			<br></br><br></br>
			
            <div class="container">
              <br></br><br></br>
              <div class="regform"><h2 style="margin-top:10px;Text-shadow:4px 4px 5px #5AA3B9;font-size:30px"> <b> All COURSE</b> </h2></div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="not_title"><?php echo $row['course']; ?></td>
                    <td class="date"><?php echo $row['date']; ?></td>
                    <td>  <a  onclick="job_delete();" href="logic.php?c_id=<?php echo $row["c_id"];?>">  <i class="fa fa-trash" ></i></a></td>
                  </tr>
                  <?php
                  }
                  }
