...
<h1 style="margin-top:30px;Text-shadow:3px 3px 5px white;background-color:#5AA3B9;font-size:40px"><b><center><span class="fa fa-book"></span>  Materials Management System  <span class="fa fa-book"></span> </center></b></h1>
		...
		<center><div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="S_feedback.php"><i class="fa fa-comments"></i>  Feedback</a></li>
	...
	<!-- End header -->
	<br></br>
	<div class="regform"><h2 style="margin-top:10px;Text-shadow:4px 4px 5px #5AA3B9;font-size:30px"> <b> STUDENT FEEDBACK FORM </b> </h2></div>
	 <div class="regmain">
		<form action="" method="post"  enctype="multipart/form-data">
		
									
			<div id="name">
				<input type="text" class="firstname" name="name" placeholder="Enter Student Name" required="">
			...
			<input type="text" name="number" class="num" placeholder="Enter Your Contact Number" required="">

			<input type="text" name="feedback_message" class="msg" placeholder="Feedback message type here..." required="">

			<input type="date" name="post_date" class="date" required="">
				...
				<div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <ul class="footer-links">
							...
							<li><a href="S_CONTACT.php">Contact</a></li>
...
<?php
	...
	if (isset ($_POST["submit"]))
	{
		...
		$sql= "INSERT INTO feedback(name,gender,email,dept,year,class,sem,number,feedback_message,post_date) 
		VALUES
		( '$name', '$gender', '$email', '$dept', '$year', '$class', '$sem', '$number', '$feedback_message', '$post_date')";
		
		if(mysqli_query($conn,$sql))
		{
			echo ' <script>alert("Feedback Registration Successfully!!")</script>';
		}
		else
		{
