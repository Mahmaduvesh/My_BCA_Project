...
<h1 style="margin-top:30px;Text-shadow:3px 3px 5px white;background-color:#5AA3B9;font-size:40px"><b><center><span class="fa fa-book"></span>  Materials Management System  <span class="fa fa-book"></span> </center></b></h1>
		...
		<center><div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active" ><a class="nav-link" href="S_STUDENT_QUERY.php">Studen Query<i class="fa fa-question"></i> </a></li>
	...
	<div class="regform"><h2 style="margin-top:10px;Text-shadow:4px 4px 5px #5AA3B9;font-size:30px"> <b> STUDENT QUERY </b> </h2></div>

	 <div class="regmain">
		<form action="" method="post"  enctype="multipart/form-data">
		
			<input type="text" class="eno" name="eno" placeholder="Enter Student Enrollment No." required="">

			<input type="text" class="rno" name="rno" placeholder="Enter Student Roll No." required="">
			...
			<input type="text" name="address" class="add" placeholder="Enter Your Current Address" required="">	
			...
			<input type="text" class="query" name="query"  placeholder="Enter Your Message..." required="">
...
<?php
	...
	if (isset ($_POST["submit"]))
	{
		...
		$sql= "INSERT INTO query (eno,rno,fname,mname,lname,gender,email,area_code,phone_no,address,date,department,year,class,sem,sub_code,sub_name,query) 
		VALUES
		( '$eno', '$rno', '$fname', '$mname', '$lname', '$gender', '$email', '$area_code', '$phone_no', '$address', '$date', '$department', '$year', '$class', '$sem', '$sub_code', '$sub_name', '$query')";
		
		if(mysqli_query($conn,$sql))
		{
			echo ' <script>alert("Student QUERY Registration Successfully!!")</script>';
		}
		else
		{
