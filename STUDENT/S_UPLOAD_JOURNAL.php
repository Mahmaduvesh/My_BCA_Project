...
<h1 style="margin-top:30px;Text-shadow:3px 3px 5px white;background-color:#5AA3B9;font-size:40px"><b><center><span class="fa fa-book"></span>  Materials Management System  <span class="fa fa-book"></span> </center></b></h1>
	...
	<div class="regform"><h2 style="margin-top:10px;Text-shadow:4px 4px 5px #5AA3B9;font-size:30px"> <b> STUDENT UPLOAD JOURNAL </b> </h2></div>
	 <div class="regmain">
...
if (isset ($_POST["submit"]))
{
	...
	$udr= '../FACULTY/upjournal/';
	$path=move_uploaded_file($tname,$udr.'/'.$pname);
	
	$sql = "INSERT INTO s_journal (eno,rno,fname,mname,lname,gender,email,depart,year,class,sem,sub_code,sub_name,ftype,file) 
	VALUES
