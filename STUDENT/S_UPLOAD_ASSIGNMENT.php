...
<h1 style="margin-top:30px;Text-shadow:3px 3px 5px white;background-color:#5AA3B9;font-size:40px"><b><center><span class="fa fa-book"></span>  Materials Management System  <span class="fa fa-book"></span> </center></b></h1>
	...
	<br></br><br></br>
		...
		<div class="regform"><h2 style="margin-top:10px;Text-shadow:4px 4px 5px #5AA3B9;font-size:30px"> <b> STUDENT UPLOAD ASSIGNMENT </b> </h2></div>
...
if (isset ($_POST["submit"]))
{
	...
	$title9=$_POST["class"];
	$title10=$_POST["sem"];
	$title11=$_POST["sub_code"];
	$title12=$_POST["sub_name"];
	$title13=$_POST["ftype"];
	$title14=$_POST["file"];
	...
	$udr= '../FACULTY/upassignment/';
	$path=move_uploaded_file($tname,$udr.'/'.$pname);
	
	$sql = "INSERT INTO s_assignment (eno,rno,fname,mname,lname,gender,email,depart,year,class,sem,sub_code,sub_name,ftype,file) 
	VALUES
	('$title0', '$title1', '$title2', '$title3', '$title4', '$title5', '$title6', '$title7', '$title8', '$title9', '$title10', '$title11', '$title12', '$title13', '$pname')";
	
	if(mysqli_query($conn,$sql))
	{
	echo '<script>alert("ASSIGNMENT Uploaded Sucessfully!!")</script>' ;
	echo "</br>";
	}
